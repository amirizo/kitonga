...
def validate_tanzania_phone_number(phone_number):
    ...
    try:
        ...
        if len(normalized) >= 6:
            ...
            vodacom_prefixes = ['255752', '255753', '255754', '255755', '255756', '255758', '255759', '255763', '255764', '255765', '255766', '255767']
            airtel_prefixes = ['255743', '255744', '255745', '255746', '255747', '255748', '255749', '255732', '255733', '255734', '255735']
            tigo_prefixes = ['255714', '255715', '255716', '255717', '255718', '255719', '255712', '255713', '255682', '255683', '255684', '255685', '255686', '255687', '255688', '255689']
            zantel_prefixes = ['255777', '255778', '255776']
            ttcl_prefixes = ['255622', '255623', '255624', '255625', '255626', '255627', '255628', '255629']
...
def get_or_create_user(phone_number, tenant=None, **kwargs):
    ...
    try:
        ...
        is_valid, network, normalized_phone = validate_tanzania_phone_number(normalized_phone)
        if not is_valid:
        ...
        try:
            if tenant:
                ...
                user = User.objects.get(phone_number=normalized_phone, tenant__isnull=True)
            return user, False
...
def find_user_by_phone(phone_number, tenant=None):
    ...
    try:
        ...
        if tenant:
            ...
            try:
                return User.objects.get(phone_number=normalized_phone, tenant__isnull=True)
            except User.DoesNotExist:
