...
class Router(models.Model):
    ...
    VPN_STATUS_CHOICES = [
        ...
        ("configured", "Configured - Waiting Connection"),
        ("connected", "Connected"),
        ("error", "Error"),
    ]
    ...
    # Connection settings
    host = models.CharField(max_length=255)  # IP or hostname (VPN IP for WireGuard)
    ...
    vpn_enabled = models.BooleanField(default=True, help_text="Use WireGuard VPN to connect to this router")
    vpn_ip = models.GenericIPAddressField(null=True, blank=True, unique=True, help_text="Auto-assigned VPN IP (10.100.0.X)")
    vpn_private_key = models.CharField(max_length=64, blank=True, help_text="Router's WireGuard private key")
    vpn_public_key = models.CharField(max_length=64, blank=True, help_text="Router's WireGuard public key")
    vpn_status = models.CharField(max_length=20, choices=VPN_STATUS_CHOICES, default="none")
    vpn_last_handshake = models.DateTimeField(null=True, blank=True)
    vpn_config_generated_at = models.DateTimeField(null=True, blank=True)
    vpn_config_downloaded = models.BooleanField(default=False, help_text="True if tenant has downloaded the config")
