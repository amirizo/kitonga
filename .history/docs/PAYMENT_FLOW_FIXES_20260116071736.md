...
function getRouterId() {
    ...
    return params['router_id'] || params['router-id'] || params['routerid'] || 
           params['rid'] || params['r'] || null
}
```
...
3. Your router ID is shown in the list or router details page
...
[User on WiFi] 
    ↓
[MikroTik Captive Portal] → login.html?router_id=X&mac=...&ip=...
    ↓
[User clicks Pay] 
    ↓
